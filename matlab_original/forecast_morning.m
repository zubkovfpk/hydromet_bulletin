...
doc=mlreportgen.dom.Document('Прогноз_утро','docx');
...
header_data=sprintf('от %s 09:00', data); %
...
paragr_name_text=sprintf('C 9:00 %s до 9:00 %s', start_data, end_data);
...
% температура
[temperature]=temp_statistics_morning(Temp(:,:,n), Temp(:,:,n+1));
